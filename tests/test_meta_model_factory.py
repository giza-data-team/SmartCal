...
from Package.src.SmartCal.meta_model.meta_model_factory import MetaModelFactory
...
class TestMetaModelFactory(unittest.TestCase):
    ...
    @patch('Package.src.SmartCal.config.configuration_manager.ConfigurationManager')
