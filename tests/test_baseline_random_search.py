...
from baseline_random_search.baseline_random_search import (
...
class TestBaselineRandomSearch(unittest.TestCase):
    ...
    @patch("baseline_random_search.baseline_random_search.StratifiedKFold.split")
    ...
    @patch("baseline_random_search.baseline_random_search.save_to_csv_incrementally")
    ...
    @patch("baseline_random_search.baseline_random_search.save_best_result")
    @patch("baseline_random_search.baseline_random_search.compute_classification_metrics")
    @patch("baseline_random_search.baseline_random_search.compute_calibration_metrics")
    @patch("baseline_random_search.baseline_random_search.apply_calibration_with_cv")
    @patch("baseline_random_search.baseline_random_search.extract_uncalibrated_data")
    @patch("baseline_random_search.baseline_random_search.fetch_completed_datasets")
    @patch("os.makedirs")
