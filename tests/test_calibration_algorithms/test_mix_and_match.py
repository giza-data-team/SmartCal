...
class TestMixAndMatchCalibrator(unittest.TestCase):
    ...
    def test_custom_initialization(self):
        ...
        """
        calibrator = MixAndMatchCalibrator(parametric_calibrator="PlattCalibrator", nonparametric_calibrator= "HistogramCalibrator")
        self.assertEqual(calibrator.parametric_calibrator.__class__.__name__, "PlattCalibrator")
    ...
    def test_invalid_combination(self):
        ...
        with self.assertRaises(KeyError):
            MixAndMatchCalibrator(parametric_calibrator="PlattCalibrator", nonparametric_calibrator="VectorScalingCalibrator")
